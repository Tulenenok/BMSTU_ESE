...
class MainWindow(QDialog):
    ...
    def task2EstimateProject(self):
        ...
        mean_price = (analyst + manager + developer + testing) / 4 / 1000
        self.lineEditMeanZP.setText(str(int(mean_price)) + ' 000 руб')
    ...
    def task3Experiment(self):
        ...
        pq_attribute_colors = ['m', 'b', 'g', 'y']
        # pq_attribute_colors = ['#E9003A', '#B1009B', '#58E000', '#C3F500']
